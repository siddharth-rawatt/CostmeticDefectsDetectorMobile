...
COLMAP_CMD = "/opt/homebrew/bin/colmap"  # Update if needed
...
if not sample_img:
    raise FileNotFoundError("❌ No .png or .jpg images found in the images folder!")
...
try:
    ...
    # 3. Sparse Reconstruction (no manual pair forced)
    run_colmap_step(
        [
            "mapper",
            "--database_path",
    ...
    print("\n✅ 3D reconstruction complete. Output saved as: fused.ply")
